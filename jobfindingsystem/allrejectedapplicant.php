...
if (isset($_SESSION["username"])) {
    ...
    <body>
        ...
        <div class="main-content">
            <div class="content">
                <h2>All Declined Applications </h2>

                <!-- Total Rejected Card -->
                <h3 style="font-weight:bold; margin-bottom:15px;">Total Declined Applications:
                    <?php echo $total_declined; ?></h3>
                ...
                <div class="jobs" style="display:flex; flex-wrap:wrap; gap:20px;">
                    ...
                    <div class='job-card'>
                        ...
                        <p><strong>Declined Date:</strong> " . date("d-m-Y", strtotime($row['rejected_at'])) . "</p>
